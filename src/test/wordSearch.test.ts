...
describe('vertical directions', () => {
	...
	xit('should locate words written bottom left to top right', () => {
		...
		const wordSearch = new WordSearch(grid)
		expect(wordSearch.find(['clojure', 'elixir', 'ecmascript', 'rust', 'java', 'lua', 'lisp'])).toEqual(expectedResults)
	})
	xit('should locate words written top right to bottom left', () => {
		...
		const wordSearch = new WordSearch(grid)
		expect(wordSearch.find(['clojure', 'elixir', 'ecmascript', 'rust', 'java', 'lua', 'lisp', 'ruby'])).toEqual(expectedResults)
	})
})
