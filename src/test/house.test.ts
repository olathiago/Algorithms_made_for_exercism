...
describe('House', () => {
	...
	it('verse four - the cat that killed', () => {
		const lyrics = ['This is the cat', 'that killed the rat', 'that ate the malt', 'that lay in the house that Jack built.']
		expect(verse(4)).toEqual(lyrics)
	})

	it('verse five - the dog that worried', () => {
		const lyrics = ['This is the dog', 'that worried the cat', 'that killed the rat', 'that ate the malt', 'that lay in the house that Jack built.']
